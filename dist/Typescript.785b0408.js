...
//String
var nombre = "Richard";
var saludo = console.log("Guten Morgen ".concat(nombre));
//Arreglos
var people = [];
...
var colorFavarito = Color.Verde;
console.log("Mi color favorito es ".concat(colorFavarito));
//Funciones
function add(a, b) {
  return a + b;
}
...
//# sourceMappingURL=/Typescript.785b0408.js.map